...
//         description:
//           "Boneless chicken breast pieces marinated with four different kind of messageure and Indian spices for each piece and grilled in clay oven",
//         price: "$16.99",
...
//       },
//       {
//         message: "Extremely disappointing in our experience.",
//         rating: 2,
//         restaurant_id: laBartolaId,
//         user_id: userLaith.id,
//       },
...
//       {
//         message:
//           "Restaurant was loud and crowded. Food is not worth the price.",
//         rating: 3,
//         restaurant_id: eldoradoTacoId,
//         user_id: userLaith.id,
//       },
//       {
//         message:
//           "A Christmas lunch with clients served by a friendly server with a good wine selection everyone enjoyed the appetizers and meals",
//         rating: 4,
//         restaurant_id: vivaanId,
//         user_id: userJosh.id,
//       },
//       {
//         message:
//           "The food was very tasty, the price is a little high so a place to go only for special occasions",
//         rating: 5,
...
//       {
//         message:
//           "Had a great time at Chops. Our server Dane was super friendly. Dinner was delicious as always.",
//         rating: 3,
//         restaurant_id: curryishTavernId,
//         user_id: userJosh.id,
//       },
//       {
//         message:
//           "The service was poor as we had to wait a long time for our food. There were some issues but were dealt with in a proper manner.",
//         rating: 3,
//         restaurant_id: adrakYorkvilleId,
//         user_id: userJosh.id,
//       },
//       {
//         message: "Wonderful food and service.",
//         rating: 5,
//         restaurant_id: coconutLagoonId,
//         user_id: userJosh.id,
//       },
//       {
//         message:
//           "Great food, great staff. You can’t ask for much more from a restaurant.",
//         rating: 5,
//         restaurant_id: bluRistoranteId,
//         user_id: userJosh.id,
//       },
...
//       },
//       {
//         message: "Very nice evening spent with special family.",
//         rating: 5,
//         restaurant_id: mariachisId,
//         user_id: userLebron.id,
//       },
//       {
//         message:
//           "First time, and not the last. Very welcoming. The food was deliscious and service very good. Highly recommend.",
//         rating: 4,
//         restaurant_id: eldoradoTacoId,
//         user_id: userLebron.id,
//       },
